defmodule RssFeed.FeedItemsTest do
  ...
  describe "feed_items" do
    ...
    @invalid_attrs %{link: nil, title: nil, author: nil, image: nil, categories: nil, duration: nil, enclosure: nil, subtitle: nil, summary: nil, updated: nil}
    ...
    test "create_feed_item/1 with valid data creates a feed_item" do
      valid_attrs = %{link: "some link", title: "some title", author: "some author", image: "some image", categories: "some categories", duration: "some duration", enclosure: "some enclosure", subtitle: "some subtitle", summary: "some summary", updated: "some updated"}
    ...
    test "update_feed_item/2 with valid data updates the feed_item" do
      feed_item = feed_item_fixture()
      update_attrs = %{link: "some updated link", title: "some updated title", author: "some updated author", image: "some updated image", categories: "some updated categories", duration: "some updated duration", enclosure: "some updated enclosure", subtitle: "some updated subtitle", summary: "some updated summary", updated: "some updated updated"}
